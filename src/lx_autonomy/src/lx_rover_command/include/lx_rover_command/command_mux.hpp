...
class CommandMux : public rclcpp::Node
{
    private:
        ...
        float max_mob_lin_vel_ = 0.5; // Reflect any defaul param changes here 
        float max_mob_ang_vel_ = 0.1; // Reflect any defaul param changes here
        float max_drum_speed_ = 0.1;  // Reflect any defaul param changes here
