...
def generate_launch_description():
  ...
  return LaunchDescription([
    ...
    #   #load yaml and set use_sim_time params
    #   parameters=[lx_ts_localization_params, {'use_sim_time': launch.substitutions.LaunchConfiguration('use_sim_time', default='true')}],
    # ),
    # Node(
    ...
    #   output='screen',
    #   arguments=['0.1', '0', '0.25', '1.57', '0', '3.1415', 'base_link', 'vectornav']
