 ...
 * Subscribers:
 *    - /odometry/ekf_global_node: Current rover positions
 *    - /cmd_vel_nav: Velocity command generated by the Nav2 controller
 *    - /cmd_vel: Velocity command for the mobile base
 * Publishers:
 *    - /rover_auto_cmd: Custom LX message of rover autonomous operation command
 *
 * - Summary
 * 
 * */
...
bool AutoNavHandler::navigateThroughPoses(){
    ...
    // Block current action return until Nav2 finishes
    ...
    /* Intermediate goal was experimented with where we give a waypoint little ahead/behind based
     * on the next action to prevent any curves in the final parts of the navigation
    ...
    */
    ...
    // Block till Nav2 action complete
    rclcpp::Rate loop_rate(10);
