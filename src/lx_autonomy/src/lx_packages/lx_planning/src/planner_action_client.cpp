...
private:
  void sendGoal()
  {
    ...
    goal_msg.goal.pose.position.x = 5.415783645379575;
    goal_msg.goal.pose.position.y = 2.37090889990329;
    ...
    // goal_msg.goal.pose.position.x = 4;
    // goal_msg.goal.pose.position.y = 3;
