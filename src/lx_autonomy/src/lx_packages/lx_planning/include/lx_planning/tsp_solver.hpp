...
int solve_tsp(const std::vector<std::vector<int64_t>> distance_matrix, bool verbose = false) {
    RoutingIndexManager manager(distance_matrix.size(), 1, RoutingIndexManager::NodeIndex({0}));
