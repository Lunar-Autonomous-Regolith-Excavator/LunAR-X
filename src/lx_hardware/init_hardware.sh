...
if tmux has-session -t "$SESSION_NAME" >/dev/null 2>&1; then
    ...
    tmux send-keys -t 0 "sr1; sleep 8; roslaunch lx_arduino_handler arduino_handler.launch" C-m
    ...
    tmux send-keys -t 2 "sr1; sleep 8; roslaunch husky_launch husky_launch.launch" C-m
    tmux send-keys -t 3 "sr1; sleep 8; rosparam load /home/lx_hardware/ros2_ws/src/lx_packages/bridge.yaml; sr2; ros2 run ros1_bridge parameter_bridge" C-m
